 ...
 */
class Goal implements ControllerInterface
{
     ...
     * @var string
     */
    protected $fields_list_file_name = 'goal_fields_list.json';

    /**
     * @var string
     */
    protected $relations_list_file_name = 'goal_relations_list.json';
    /**
     * Offer constructor.
